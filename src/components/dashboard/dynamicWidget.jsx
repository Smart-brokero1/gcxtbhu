    ...
    <div className="absoluteDynamicWidget">
      ...
      {widgetState.type === "invest" && (
        <div className="avatarSection investwidgetSection">
          ...
          <p>
            You are about to invest in the <span>{investData?.plan}</span> Offer
            which takes a period of <span>{investData?.duration} days</span>
          </p>
          <div className="investMinmax">
            {investData?.plan === "Silver"
              ? "Min. Capital: USD 100 | Max. Capital: USD 900"
              : investData?.plan === "Gold"
              ? "Min. Capital: USD 1000 | Max. Capital: USD 9000"
              : "Min. Capital: USD 10,000 | Max. Capital: USD 100,000"}
          </div>
